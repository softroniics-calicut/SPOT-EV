...
class _bookingCompleteState extends State<bookingComplete> {
  ...
  Future<dynamic> getData() async {
    ...
    var response = await post(Uri.parse('${con.url}/bookings.php'),body: data);
    print(response.body);
  ...
  void deleteData(id)async{
    ...
    print(data);
    var response =await post(Uri.parse('${con.url}/del-booking.php'),body: data);
    print(response.body);
    setState(() {});
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        onTap: (){
                                          deleteData(snapshot.data[index]['booking_id']);
                                        },
                                        child: Container(
                                          height: 40,
                                          width: 130,
